...
const SettingsPage = () => {
  ...
  const submitImageUpdate = async (field) => {
    ...
    try {
      ...
      toast.success(
        `${
          field === "profilePicture" ? "Profile picture" : "Cover image"
        } updated successfully!`
      );
        ...
        {field === "profilePicture" || field === "coverImage" ? (
          <div className="space-y-3">
                ...
                <div className="mt-3">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setNewImageFile(null);
                      setNewImagePreview(e.target.value || null);
                    }}
            ...
            <div className="flex gap-2 justify-end">
              <button
                onClick={() => handleDeleteAccount(field)}
                className="px-4 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-white font-semibold transition-all duration-200"
              >
                Delete
              </button>

              <button
                onClick={() => submitImageUpdate(field)}
