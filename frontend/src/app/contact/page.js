...
export default function ContactPage() {
  ...
  const socialMedia = [
    {
      name: "LinkedIn",
      link: "https://www.linkedin.com/in/rakesh-kummari-b9028429b/",
      icon: <FaLinkedin className="text-2xl" />,
      description:
        "Connect with me professionally and explore my career journey.",
      username: "Rakesh Kummari",
    ...
    {
      name: "GitHub",
      link: "https://github.com/Rakesh-Kummari",
    ...
    {
      name: "Instagram",
      link: "https://www.instagram.com/rakesh.kummari_?igsh=ZmxiY2FxcmJvbWds",
  ...
  const contactMethods = [
    {
      ...
      action: "mailto:rajbabukummari0341@gmail.com",
    ...
    },
    {
      ...
      action: "https://wa.me/+917588682086",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
              Choose your preferred way to reach out. I'm always open to new
              opportunities, collaborations, or just a friendly conversation.
            </p>
          </motion.div>
                ...
                >
                  <div className="p-6">
                    <div className="flex justify-between items-start mb-6">
                      <div
                        className={`p-3 rounded-xl text-white ${media.iconBg}`}
                      >
                        {media.icon}
                      </div>
                      <motion.div
                        animate={{
                          rotate: activeCard === media.name ? 360 : 0,
                        }}
                        transition={{ duration: 0.5 }}
          ...
          >
            <div className="bg-gray-50 py-12 px-6 rounded-2xl max-w-3xl mx-auto">
              ...
              <p className="text-gray-600 mb-8">
                Check out my complete portfolio to see my projects, skills, and
                experience.
              </p>
              <motion.a
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                href="https://rakesh-portfolio-t1sf.onrender.com"
                target="_blank"
                rel="noopener noreferrer"
